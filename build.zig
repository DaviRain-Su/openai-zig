...
pub fn build(b: *std.Build) void {
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "openai_zig" is the name you will use in your source code to
                // import this module (e.g. `@import("openai_zig")`). The name is
    ...
    if (build_examples) {
        const examples = [_]struct { name: []const u8, path: []const u8 }{
            ...
            .{ .name = "chat_completion_raw", .path = "examples/chat_completion_raw.zig" },
