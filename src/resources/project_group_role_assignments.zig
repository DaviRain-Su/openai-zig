...
pub const Resource = struct {
    ...
    pub fn list_project_group_role_assignments(
        ...
        return self.list_project_group_role_assignments_with_options(allocator, project_id, group_id, params, null);
    }

    pub fn list_project_group_role_assignments_with_options(
        self: *const Resource,
        allocator: std.mem.Allocator,
        project_id: []const u8,
        group_id: []const u8,
    ...
    pub fn assign_project_group_role(
        ...
        return self.assign_project_group_role_with_options(allocator, project_id, group_id, req, null);
    }

    pub fn assign_project_group_role_with_options(
        self: *const Resource,
        allocator: std.mem.Allocator,
        project_id: []const u8,
        group_id: []const u8,
    ...
    pub fn unassign_project_group_role(
        ...
        return self.unassign_project_group_role_with_options(allocator, project_id, group_id, role_id, null);
    }

    pub fn unassign_project_group_role_with_options(
        self: *const Resource,
        allocator: std.mem.Allocator,
        project_id: []const u8,
        group_id: []const u8,
